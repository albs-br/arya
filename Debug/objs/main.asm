...
;src\/Graphics\Countdown.h:114: }
	...
	pop	ix
	ret
;src\/Graphics\Graphics.h:1: void ClearNamesTable() {
;	---------------------------------
; Function ClearNamesTable
; ---------------------------------
_ClearNamesTable::
;src\/Graphics\Graphics.h:2: FILVRM(NAMTBL, 768, 0);
	xor	a, a
	push	af
	inc	sp
	ld	hl, #0x0300
...
;src\/Graphics\Graphics.h:3: }
	ret
;src\/Graphics\Graphics.h:5: void DrawChar(byte character, byte col, byte line) {
;	---------------------------------
; Function DrawChar
; ---------------------------------
_DrawChar::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:6: WRTVRM(NAMTBL + (line * 32) + col, character);
	ld	l, 6 (ix)
	ld	h, #0x00
	add	hl, hl
	add	hl, hl
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:7: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:9: void DrawString(const char* str, byte col, byte line) {
;	---------------------------------
; Function DrawString
; ---------------------------------
_DrawString::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:10: while (*str) {
	ld	l, 6 (ix)
	ld	c, 4 (ix)
	ld	b, 5 (ix)
00101$:
	...
	or	a, a
	jr	Z, 00104$
;src\/Graphics\Graphics.h:11: DrawChar((*str++) - (65 - CHAR_A), col++, line);
	ld	d, l
	inc	l
	ld	6 (ix), l
	inc	bc
	...
	jr	00101$
00104$:
;src\/Graphics\Graphics.h:13: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:15: void DrawNumber(word number, byte col, byte line) {
;	---------------------------------
; Function DrawNumber
; ---------------------------------
_DrawNumber::
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:18: bool trailingZero = TRUE;
	ld	-6 (ix), #0x01
;src\/Graphics\Graphics.h:20: DrawString("      ", col, line); // Clear space for number (6 digits)
	ld	h, 7 (ix)
	ld	l, 6 (ix)
	push	hl
	ld	hl, #___str_0
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:22: for(byte i = 6; i > 0; i--) { //  (6 digits)
	ld	a, 6 (ix)
	ld	-1 (ix), a
	ld	e, #0x06
00109$:
	...
	or	a, a
	jp	Z, 00111$
;src\/Graphics\Graphics.h:24: power = Power(10, i - 1);
	ld	a, e
	dec	a
	push	de
	ld	d,a
	...
	ld	-5 (ix), l
	ld	-4 (ix), h
;src\/Graphics\Graphics.h:26: if(trailingZero && (number / power) != 0) trailingZero = FALSE;
	push	de
	ld	l, -5 (ix)
	ld	h, -4 (ix)
	push	hl
	...
	ld	-6 (ix), #0
00102$:
;src\/Graphics\Graphics.h:28: if(!trailingZero || i == 1) {
	ld	a, -6 (ix)
	or	a, a
	jr	Z, 00104$
	ld	a, e
	...
	jr	NZ, 00105$
00104$:
;src\/Graphics\Graphics.h:29: DrawChar((number / power) + CHAR_0, col, line);
	ld	a, -3 (ix)
	add	a, #0x3f
	push	de
	ld	h, 7 (ix)
	...
	ld	5 (ix), h
00105$:
;src\/Graphics\Graphics.h:33: col++;
	inc	-1 (ix)
;src\/Graphics\Graphics.h:22: for(byte i = 6; i > 0; i--) { //  (6 digits)
	dec	e
	jp	00109$
00111$:
;src\/Graphics\Graphics.h:38: }
	ld	sp, ix
	pop	ix
	ret
___str_0:
	.ascii "      "
	.db 0x00
;src\/Graphics\Graphics.h:40: void DrawColumn(byte col) {
;	---------------------------------
; Function DrawColumn
; ---------------------------------
_DrawColumn::
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:41: WRTVRM(NAMTBL + col + 0, COLUMN_TOP_1);
	ld	c, 4 (ix)
	ld	b, #0x00
	ld	hl, #0x1800
	add	hl, bc
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:42: WRTVRM(NAMTBL + col + 1, COLUMN_TOP_1 + 1);
	ld	hl, #0x1801
	add	hl, bc
	push	bc
	ld	a, #0x19
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:43: WRTVRM(NAMTBL + col + 2, COLUMN_TOP_1 + 2);
	ld	hl, #0x1802
	add	hl, bc
	push	bc
	ld	a, #0x1a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:44: WRTVRM(NAMTBL + col + 32, COLUMN_TOP_1 + 3);
	ld	hl, #0x1820
	add	hl, bc
	push	bc
	ld	a, #0x1b
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:45: WRTVRM(NAMTBL + col + 33, COLUMN_TOP_1 + 4);
	ld	hl, #0x1821
	add	hl, bc
	push	bc
	ld	a, #0x1c
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:46: WRTVRM(NAMTBL + col + 34, COLUMN_TOP_1 + 5);
	ld	hl, #0x1822
	add	hl, bc
	push	bc
	ld	a, #0x1d
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:48: for(byte i=0; i<20; i++) {
	ld	hl, #0x1840
	add	hl, bc
	ex	(sp), hl
	ld	hl, #0x1841
...
00103$:
	...
	sub	a, #0x14
	jr	NC, 00101$
;src\/Graphics\Graphics.h:49: WRTVRM(NAMTBL + col + 64 + (i*32), COLUMN_MIDDLE_1);
	ld	e, -1 (ix)
	ld	d, #0x00
	ex	de, hl
	add	hl, hl
	...
	pop	de
	pop	bc
;src\/Graphics\Graphics.h:50: WRTVRM(NAMTBL + col + 65 + (i*32), COLUMN_MIDDLE_1 + 1);
	ld	l, -5 (ix)
	ld	h, -4 (ix)
	add	hl, de
	push	bc
	...
	pop	de
	pop	bc
;src\/Graphics\Graphics.h:51: WRTVRM(NAMTBL + col + 66 + (i*32), COLUMN_MIDDLE_1 + 2);
	ld	l, -3 (ix)
	ld	h, -2 (ix)
	add	hl, de
	push	bc
...
;src\/Graphics\Graphics.h:48: for(byte i=0; i<20; i++) {
	...
	jr	00103$
00101$:
;src\/Graphics\Graphics.h:54: WRTVRM(NAMTBL + col + (32 * 8), COLUMN_MIDDLE_2);
	ld	hl, #0x1900
	add	hl, bc
	push	bc
	ld	a, #0x21
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:55: WRTVRM(NAMTBL + col + (32 * 8) + 1, COLUMN_MIDDLE_2 + 1);
	ld	hl, #0x1901
	add	hl, bc
	push	bc
	ld	a, #0x22
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:56: WRTVRM(NAMTBL + col + (32 * 8) + 2, COLUMN_MIDDLE_2 + 2);
	ld	hl, #0x1902
	add	hl, bc
	push	bc
	ld	a, #0x23
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:58: WRTVRM(NAMTBL + col + (32 * 16), COLUMN_MIDDLE_2);
	ld	hl, #0x1a00
	add	hl, bc
	push	bc
	ld	a, #0x21
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:59: WRTVRM(NAMTBL + col + (32 * 16) + 1, COLUMN_MIDDLE_2 + 1);
	ld	hl, #0x1a01
	add	hl, bc
	push	bc
	ld	a, #0x22
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:60: WRTVRM(NAMTBL + col + (32 * 16) + 2, COLUMN_MIDDLE_2 + 2);
	ld	hl, #0x1a02
	add	hl, bc
	push	bc
	ld	a, #0x23
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:62: WRTVRM(NAMTBL + col + (32 * 22) + 0, COLUMN_BOTTOM_1);
	ld	hl, #0x1ac0
	add	hl, bc
	push	bc
	ld	a, #0x24
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:63: WRTVRM(NAMTBL + col + (32 * 22) + 1, COLUMN_BOTTOM_1 + 1);
	ld	hl, #0x1ac1
	add	hl, bc
	push	bc
	ld	a, #0x25
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:64: WRTVRM(NAMTBL + col + (32 * 22) + 2, COLUMN_BOTTOM_1 + 2);
	ld	hl, #0x1ac2
	add	hl, bc
	push	bc
	ld	a, #0x26
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:65: WRTVRM(NAMTBL + col + (32 * 22) + 32, COLUMN_BOTTOM_1 + 3);
	ld	hl, #0x1ae0
	add	hl, bc
	push	bc
	ld	a, #0x27
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:66: WRTVRM(NAMTBL + col + (32 * 22) + 33, COLUMN_BOTTOM_1 + 4);
	ld	hl, #0x1ae1
	add	hl, bc
	push	bc
	ld	a, #0x28
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:67: WRTVRM(NAMTBL + col + (32 * 22) + 34, COLUMN_BOTTOM_1 + 5);
	ld	hl, #0x1ae2
	add	hl, bc
	ld	a, #0x29
	push	af
	...
	push	hl
	call	_WRTVRM
;src\/Graphics\Graphics.h:68: }
	ld	sp,ix
	pop	ix
	ret
;src\/Graphics\Graphics.h:73: void GetNextPieceColors(byte sourcePiece) {
;	---------------------------------
; Function GetNextPieceColors
; ---------------------------------
_GetNextPieceColors::
;src\/Graphics\Graphics.h:74: switch(sourcePiece) {
	ld	iy, #2
	add	iy, sp
	ld	a, 0 (iy)
	sub	a, #0x04
	...
	jr	Z, 00104$
	jr	00105$
;src\/Graphics\Graphics.h:75: case TILE_BLUE:
00101$:
;src\/Graphics\Graphics.h:76: nextPieceColor_Front = 7;
	ld	a, #0x07
	ld	(#_nextPieceColor_Front), a
;src\/Graphics\Graphics.h:77: nextPieceColor_Back = 4;
	ld	a, #0x04
	ld	(#_nextPieceColor_Back), a
;src\/Graphics\Graphics.h:78: break;
	ret
;src\/Graphics\Graphics.h:79: case TILE_GREEN:
00102$:
;src\/Graphics\Graphics.h:80: nextPieceColor_Front = 3;
	ld	a, #0x03
	ld	(#_nextPieceColor_Front), a
;src\/Graphics\Graphics.h:81: nextPieceColor_Back = 12;
	ld	a, #0x0c
	ld	(#_nextPieceColor_Back), a
;src\/Graphics\Graphics.h:82: break;
	ret
;src\/Graphics\Graphics.h:83: case TILE_RED:
00103$:
;src\/Graphics\Graphics.h:84: nextPieceColor_Front = 9;
	ld	a, #0x09
	ld	(#_nextPieceColor_Front), a
;src\/Graphics\Graphics.h:85: nextPieceColor_Back = 6;
	ld	a, #0x06
	ld	(#_nextPieceColor_Back), a
;src\/Graphics\Graphics.h:86: break;
	ret
;src\/Graphics\Graphics.h:87: case TILE_YELLOW:
00104$:
;src\/Graphics\Graphics.h:88: nextPieceColor_Front = 11;
	ld	a, #0x0b
	ld	(#_nextPieceColor_Front), a
;src\/Graphics\Graphics.h:89: nextPieceColor_Back = 10;
	ld	a, #0x0a
	ld	(#_nextPieceColor_Back), a
;src\/Graphics\Graphics.h:90: break;
	ret
;src\/Graphics\Graphics.h:91: default:
00105$:
;src\/Graphics\Graphics.h:92: nextPieceColor_Front = 15;
	ld	a, #0x0f
	ld	(#_nextPieceColor_Front), a
;src\/Graphics\Graphics.h:93: nextPieceColor_Back = 13;
	ld	a, #0x0d
	ld	(#_nextPieceColor_Back), a
;src\/Graphics\Graphics.h:94: }  
;src\/Graphics\Graphics.h:95: }
	ret
;src\/Graphics\Graphics.h:97: void PosMaskSprites(word VRAMaddress, byte y) {
;	---------------------------------
...
_PosMaskSprites::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:99: WRTVRM(VRAMaddress, 	    y);
	ld	a, 6 (ix)
	push	af
	inc	sp
	ld	l, 4 (ix)
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:100: WRTVRM(VRAMaddress + 1, 	0);
	ld	c, 4 (ix)
	ld	b, 5 (ix)
	ld	e, c
	ld	d, b
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:101: WRTVRM(VRAMaddress + 2, 	0); // Pattern don't matter
	ld	e, c
	ld	d, b
	inc	de
	inc	de
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:102: WRTVRM(VRAMaddress + 3, 	0b1000000); // Early Clock bit makes x = -32 (out of the screen)
	ld	e, c
	ld	d, b
	inc	de
	inc	de
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:104: WRTVRM(VRAMaddress + 4,   y);
	ld	hl, #0x0004
	add	hl, bc
	push	bc
	ld	a, 6 (ix)
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:105: WRTVRM(VRAMaddress + 5, 	0);
	ld	hl, #0x0005
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:106: WRTVRM(VRAMaddress + 6, 	0); // Pattern don't matter
	ld	hl, #0x0006
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:107: WRTVRM(VRAMaddress + 7, 	0b1000000); // Early Clock bit makes x = -32 (out of the screen)
	ld	hl, #0x0007
	add	hl, bc
	push	bc
	ld	a, #0x40
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:109: WRTVRM(VRAMaddress + 8,   y);
	ld	hl, #0x0008
	add	hl, bc
	push	bc
	ld	a, 6 (ix)
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:110: WRTVRM(VRAMaddress + 9, 	0);
	ld	hl, #0x0009
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:111: WRTVRM(VRAMaddress + 10,	0); // Pattern don't matter
	ld	hl, #0x000a
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:112: WRTVRM(VRAMaddress + 11,	0b1000000); // Early Clock bit makes x = -32 (out of the screen)
	ld	hl, #0x000b
	add	hl, bc
	push	bc
	ld	a, #0x40
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:114: WRTVRM(VRAMaddress + 12,  y);
	ld	hl, #0x000c
	add	hl, bc
	push	bc
	ld	a, 6 (ix)
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:115: WRTVRM(VRAMaddress + 13,	0);
	ld	hl, #0x000d
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:116: WRTVRM(VRAMaddress + 14,	0); // Pattern don't matter
	ld	hl, #0x000e
	add	hl, bc
	push	bc
	xor	a, a
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:117: WRTVRM(VRAMaddress + 15,	0b1000000); // Early Clock bit makes x = -32 (out of the screen)  
	ld	hl, #0x000f
	add	hl, bc
	ld	a, #0x40
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:118: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:120: void DrawNextPiece() {
;	---------------------------------
...
_DrawNextPiece::
	push	af
	push	af
;src\/Graphics\Graphics.h:124: PosMaskSprites(SPRATT, 24+24);
	ld	a, #0x30
	push	af
	inc	sp
	ld	hl, #0x1b00
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:125: PosMaskSprites(SPRATT + 16, 24+24+16);
	ld	a, #0x40
	push	af
	inc	sp
	ld	hl, #0x1b10
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:128: PosMaskSprites(SPRATT + 32, 255); // first line
	ld	a, #0xff
	push	af
	inc	sp
	ld	hl, #0x1b20
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:130: while(counter++ < 25) {
	ld	iy, #2
	add	iy, sp
	ld	0 (iy), #0x30
	xor	a, a
...
00104$:
	...
	jp	NC, 00106$
	inc	0 (iy)
;src\/Graphics\Graphics.h:132: word lastJiffy = JIFFY;
	ld	bc, (_JIFFY)
;src\/Graphics\Graphics.h:133: while (lastJiffy == JIFFY) {
00101$:
	ld	hl, (_JIFFY)
	cp	a, a
	sbc	hl, bc
	jr	Z, 00101$
;src\/Graphics\Graphics.h:138: GetNextPieceColors(topPiece);
	ld	a,(#_topPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:139: WRTVRM(SPRATT + 64, 	y - 32);                       // Code repeated for performance reasons
	ld	iy, #2
	add	iy, sp
	ld	a, 0 (iy)
	dec	iy
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:140: WRTVRM(SPRATT + 65, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b41
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:141: WRTVRM(SPRATT + 66, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b42
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:142: WRTVRM(SPRATT + 67, 	nextPieceColor_Front);
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:143: WRTVRM(SPRATT + 68, 	y - 32);
	ld	hl, #0
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:144: WRTVRM(SPRATT + 69, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b45
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:145: WRTVRM(SPRATT + 70, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b46
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:146: WRTVRM(SPRATT + 71, 	nextPieceColor_Back);
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:148: GetNextPieceColors(midPiece);
	ld	a,(#_midPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:149: WRTVRM(SPRATT + 72, 	y - 24);
	ld	hl, #0
	add	hl, sp
	ld	iy, #1
	add	iy, sp
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:150: WRTVRM(SPRATT + 73, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b49
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:151: WRTVRM(SPRATT + 74, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b4a
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:152: WRTVRM(SPRATT + 75, 	nextPieceColor_Front);
	ld	a,(#_nextPieceColor_Front + 0)
	push	af
	inc	sp
	ld	hl, #0x1b4b
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:153: WRTVRM(SPRATT + 76, 	y - 24);
	ld	hl, #0
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:154: WRTVRM(SPRATT + 77, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b4d
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:155: WRTVRM(SPRATT + 78, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b4e
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:156: WRTVRM(SPRATT + 79, 	nextPieceColor_Back);    
	ld	a,(#_nextPieceColor_Back + 0)
	push	af
	inc	sp
	ld	hl, #0x1b4f
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:158: GetNextPieceColors(bottomPiece);
	ld	a,(#_bottomPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:159: WRTVRM(SPRATT + 80, 	y - 16);
	ld	hl, #0
	add	hl, sp
	ld	iy, #1
	add	iy, sp
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:160: WRTVRM(SPRATT + 81, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b51
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:161: WRTVRM(SPRATT + 82, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b52
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:162: WRTVRM(SPRATT + 83, 	nextPieceColor_Front);
	ld	a,(#_nextPieceColor_Front + 0)
	push	af
	inc	sp
	ld	hl, #0x1b53
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:163: WRTVRM(SPRATT + 84, 	y - 16);
	ld	hl, #0
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:164: WRTVRM(SPRATT + 85, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b55
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:165: WRTVRM(SPRATT + 86, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b56
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:166: WRTVRM(SPRATT + 87, 	nextPieceColor_Back);    
	ld	a,(#_nextPieceColor_Back + 0)
	push	af
	inc	sp
	ld	hl, #0x1b57
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:169: GetNextPieceColors(nextTopPiece);
	ld	a,(#_nextTopPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:170: WRTVRM(SPRATT + 88, 	y);                       // Code repeated for performance reasons
	ld	hl, #2
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:171: WRTVRM(SPRATT + 89, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b59
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:172: WRTVRM(SPRATT + 90, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b5a
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:173: WRTVRM(SPRATT + 91, 	nextPieceColor_Front);
	ld	a,(#_nextPieceColor_Front + 0)
	push	af
	inc	sp
	ld	hl, #0x1b5b
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:174: WRTVRM(SPRATT + 92, 	y);
	ld	hl, #2
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:175: WRTVRM(SPRATT + 93, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b5d
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:176: WRTVRM(SPRATT + 94, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b5e
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:177: WRTVRM(SPRATT + 95, 	nextPieceColor_Back);
	ld	a,(#_nextPieceColor_Back + 0)
	push	af
	inc	sp
	ld	hl, #0x1b5f
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:179: GetNextPieceColors(nextMidPiece);
	ld	a,(#_nextMidPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:180: WRTVRM(SPRATT + 96, 	y + 8);
	ld	iy, #1
	add	iy, sp
	ld	a, 0 (iy)
	add	a, #0x08
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:181: WRTVRM(SPRATT + 97, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b61
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:182: WRTVRM(SPRATT + 98, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b62
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:183: WRTVRM(SPRATT + 99, 	nextPieceColor_Front);
	ld	a,(#_nextPieceColor_Front + 0)
	push	af
	inc	sp
	ld	hl, #0x1b63
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:184: WRTVRM(SPRATT + 100, 	y + 8);
	ld	hl, #0
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:185: WRTVRM(SPRATT + 101, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b65
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:186: WRTVRM(SPRATT + 102, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b66
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:187: WRTVRM(SPRATT + 103, 	nextPieceColor_Back);
	ld	a,(#_nextPieceColor_Back + 0)
	push	af
	inc	sp
	ld	hl, #0x1b67
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:189: GetNextPieceColors(nextBottomPiece);
	ld	a,(#_nextBottomPiece + 0)
	push	af
	inc	sp
	call	_GetNextPieceColors
	inc	sp
;src\/Graphics\Graphics.h:190: WRTVRM(SPRATT + 104, 	y + 16);
	ld	iy, #1
	add	iy, sp
	ld	a, 0 (iy)
	add	a, #0x10
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:191: WRTVRM(SPRATT + 105, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b69
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:192: WRTVRM(SPRATT + 106, 	SPRITE_PATTERN_SMALL_BLOCK);
	ld	a, #0x4c
	push	af
	inc	sp
	ld	hl, #0x1b6a
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:193: WRTVRM(SPRATT + 107, 	nextPieceColor_Front);
	ld	a,(#_nextPieceColor_Front + 0)
	push	af
	inc	sp
	ld	hl, #0x1b6b
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:194: WRTVRM(SPRATT + 108, 	y + 16);
	ld	hl, #1
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:195: WRTVRM(SPRATT + 109, 	(4 * 8)-4);
	ld	a, #0x1c
	push	af
	inc	sp
	ld	hl, #0x1b6d
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:196: WRTVRM(SPRATT + 110, 	SPRITE_PATTERN_SMALL_BLOCK + 4);
	ld	a, #0x50
	push	af
	inc	sp
	ld	hl, #0x1b6e
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:197: WRTVRM(SPRATT + 111, 	nextPieceColor_Back);
	ld	a,(#_nextPieceColor_Back + 0)
	push	af
	inc	sp
	ld	hl, #0x1b6f
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:199: y--;
	ld	iy, #2
	add	iy, sp
	dec	0 (iy)
	jp	00104$
00106$:
;src\/Graphics\Graphics.h:203: WRTVRM(SPRATT + 64, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b40
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:204: WRTVRM(SPRATT + 68, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b44
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:205: WRTVRM(SPRATT + 72, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b48
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:206: WRTVRM(SPRATT + 76, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b4c
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:207: WRTVRM(SPRATT + 80, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b50
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:208: WRTVRM(SPRATT + 84, 	192);
	ld	a, #0xc0
	push	af
	inc	sp
	ld	hl, #0x1b54
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:209: }
	pop	af
	pop	af
	ret
;src\/Graphics\Graphics.h:211: void DrawScore() {
;	---------------------------------
; Function DrawScore
; ---------------------------------
_DrawScore::
	...
	add	ix,sp
	push	af
;src\/Graphics\Graphics.h:212: byte bgCounter = 0, bgColor;
	ld	-2 (ix), #0
;src\/Graphics\Graphics.h:216: if(newLevel) {
	ld	a,(#_newLevel + 0)
	or	a, a
	jp	Z, 00119$
;src\/Graphics\Graphics.h:217: for(byte i=0; i < 60; i++) {
	ld	-1 (ix), #0
00121$:
	ld	a, -1 (ix)
	sub	a, #0x3c
	jp	NC, 00119$
;src\/Graphics\Graphics.h:218: lastJiffy = JIFFY;
	ld	bc, (_JIFFY)
;src\/Graphics\Graphics.h:219: while(lastJiffy == JIFFY) { }
00101$:
	ld	hl, (_JIFFY)
	cp	a, a
	sbc	hl, bc
	jr	Z, 00101$
;src\/Graphics\Graphics.h:221: DrawExplosionSprite(26 * 8, 10 * 8, i);
	ld	d, -1 (ix)
	ld	e,#0x50
	push	de
	ld	a, #0xd0
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:223: if(JIFFY & 0b00000110) {
	ld	hl, (_JIFFY)
	ld	a, l
	and	a, #0x06
	jp	Z,00115$
;src\/Graphics\Graphics.h:225: DrawString(" LEVEL", 26, 10);
	ld	de, #0x0a1a
	push	de
	ld	hl, #___str_1
	push	hl
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:226: DrawNumber(level, 26, 11);
	ld	a, (#_level + 0)
	ld	c, a
	ld	b, #0x00
	ld	de, #0x0b1a
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:232: switch(bgCounter++) {
	ld	c, -2 (ix)
	inc	-2 (ix)
	ld	a, #0x07
	sub	a, c
...
00163$:
	...
	jp	00110$
	jp	00111$
;src\/Graphics\Graphics.h:233: case 0:
00104$:
;src\/Graphics\Graphics.h:234: bgColor = 0x14;
	ld	c, #0x14
;src\/Graphics\Graphics.h:235: break;
	jr	00113$
;src\/Graphics\Graphics.h:236: case 1:
00105$:
;src\/Graphics\Graphics.h:237: bgColor = 0x15;
	ld	c, #0x15
;src\/Graphics\Graphics.h:238: break;
	jr	00113$
;src\/Graphics\Graphics.h:239: case 2:
00106$:
;src\/Graphics\Graphics.h:240: bgColor = 0x17;
	ld	c, #0x17
;src\/Graphics\Graphics.h:241: break;
	jr	00113$
;src\/Graphics\Graphics.h:242: case 3:
00107$:
;src\/Graphics\Graphics.h:243: bgColor = 0x1e;
	ld	c, #0x1e
;src\/Graphics\Graphics.h:244: break;
	jr	00113$
;src\/Graphics\Graphics.h:245: case 4:
00108$:
;src\/Graphics\Graphics.h:246: bgColor = 0x1f;
	ld	c, #0x1f
;src\/Graphics\Graphics.h:247: break;
	jr	00113$
;src\/Graphics\Graphics.h:248: case 5:
00109$:
;src\/Graphics\Graphics.h:249: bgColor = 0x1e;
	ld	c, #0x1e
;src\/Graphics\Graphics.h:250: break;
	jr	00113$
;src\/Graphics\Graphics.h:251: case 6:
00110$:
;src\/Graphics\Graphics.h:252: bgColor = 0x17;
	ld	c, #0x17
;src\/Graphics\Graphics.h:253: break;
	jr	00113$
;src\/Graphics\Graphics.h:254: case 7:
00111$:
;src\/Graphics\Graphics.h:255: bgColor = 0x15;
	ld	c, #0x15
;src\/Graphics\Graphics.h:256: bgCounter = 0;
	ld	-2 (ix), #0
;src\/Graphics\Graphics.h:257: break;
	jr	00113$
;src\/Graphics\Graphics.h:258: default:
00112$:
;src\/Graphics\Graphics.h:259: bgColor = 0x11;
	ld	c, #0x11
;src\/Graphics\Graphics.h:261: }
00113$:
;src\/Graphics\Graphics.h:262: FILVRM(CLRTBL, 8 * 4, bgColor);
	push	bc
	ld	a, c
	push	af
	inc	sp
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:263: FILVRM(CLRTBL + (256 * 8), 8 * 4, bgColor);
	push	bc
	ld	a, c
	push	af
	inc	sp
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:264: FILVRM(CLRTBL + (512 * 8), 8 * 4, bgColor);
	ld	a, c
	push	af
	inc	sp
	ld	hl, #0x0020
	...
	jr	00122$
00115$:
;src\/Graphics\Graphics.h:269: DrawString("      ", 26, 10);
	ld	de, #0x0a1a
	push	de
	ld	hl, #___str_2
	push	hl
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:270: DrawString("      ", 26, 11);
	ld	de, #0x0b1a
	push	de
	ld	hl, #___str_2
	push	hl
...
;src\/Graphics\Graphics.h:217: for(byte i=0; i < 60; i++) {
	...
	jp	00121$
00119$:
;src\/Graphics\Graphics.h:276: newLevel = FALSE;
	ld	hl, #_newLevel
	ld	(hl), #0x00
;src\/Graphics\Graphics.h:279: FILVRM(CLRTBL, 8 * 4, 0x14);
	ld	a, #0x14
	push	af
	inc	sp
	ld	hl, #0x0020
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:280: FILVRM(CLRTBL + (256 * 8), 8 * 4, 0x14);
	ld	a, #0x14
	push	af
	inc	sp
	ld	hl, #0x0020
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:281: FILVRM(CLRTBL + (512 * 8), 8 * 4, 0x14);
	ld	a, #0x14
	push	af
	inc	sp
	ld	hl, #0x0020
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:283: DrawString("NEXT", 2, 1);
	ld	de, #0x0102
	push	de
	ld	hl, #___str_3
	push	hl
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:285: DrawString(" LEVEL", 26, 10);
	ld	de, #0x0a1a
	push	de
	ld	hl, #___str_1
	push	hl
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:286: DrawString("BLOCKS", 26, 18);
	ld	de, #0x121a
	push	de
	ld	hl, #___str_4
	push	hl
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:289: DrawNumber(level, 26, 11);
	ld	a, (#_level + 0)
	ld	c, a
	ld	b, #0x00
	ld	de, #0x0b1a
	...
	pop	af
	pop	af
;src\/Graphics\Graphics.h:290: DrawNumber(blocksRemoved, 26, 19);
	ld	de, #0x131a
	push	de
	ld	hl, (_blocksRemoved)
	push	hl
	call	_DrawNumber
;src\/Graphics\Graphics.h:293: }
	ld	sp,ix
	pop	ix
	ret
___str_1:
...
___str_4:
	.ascii "BLOCKS"
	.db 0x00
;src\/Graphics\Graphics.h:295: void DrawBackground() {
;	---------------------------------
; Function DrawBackground
; ---------------------------------
_DrawBackground::
;src\/Graphics\Graphics.h:297: for(int i = 0; i < 256 * 3; i++) {
	ld	bc, #0x0000
00103$:
	ld	a, b
	xor	a, #0x80
	sub	a, #0x83
	jr	NC, 00101$
;src\/Graphics\Graphics.h:298: WRTVRM(NAMTBL + i, EMPTY); // test
	ld	hl, #0x1800
	add	hl, bc
	push	bc
	xor	a, a
...
;src\/Graphics\Graphics.h:297: for(int i = 0; i < 256 * 3; i++) {
	...
	jr	00103$
00101$:
;src\/Graphics\Graphics.h:301: DrawColumn(7);
	ld	a, #0x07
	push	af
	inc	sp
	call	_DrawColumn
	inc	sp
;src\/Graphics\Graphics.h:302: DrawColumn(22);
	ld	a, #0x16
	push	af
	inc	sp
	call	_DrawColumn
	inc	sp
;src\/Graphics\Graphics.h:304: DrawScore();
;src\/Graphics\Graphics.h:340: }
	jp	_DrawScore
;src\/Graphics\Graphics.h:342: void InitVRAM() {
;	---------------------------------
; Function InitVRAM
; ---------------------------------
_InitVRAM::
	...
	add	ix,sp
	dec	sp
;src\/Graphics\Graphics.h:347: CLIKSW = 0;	// disable keyboard sound
	ld	hl, #0x0000
	ld	(_CLIKSW), hl
;src\/Graphics\Graphics.h:348: SCNCNT = 1; 	// set keyboard scan counter
	ld	hl, #_SCNCNT
	ld	(hl), #0x01
;src\/Graphics\Graphics.h:350: FORCLR = COLOR_WHITE;
	ld	hl, #_FORCLR
	ld	(hl), #0x0f
;src\/Graphics\Graphics.h:351: BAKCLR = COLOR_BLACK;
	ld	hl, #_BAKCLR
	ld	(hl), #0x01
;src\/Graphics\Graphics.h:352: BDRCLR = COLOR_BLACK;
	ld	hl, #_BDRCLR
	ld	(hl), #0x01
;src\/Graphics\Graphics.h:380: WRTVDP(0b0000000111100010);
	ld	hl, #0x01e2
	call	_WRTVDP
;src\/Graphics\Graphics.h:382: INIGRP();	// Set screen 2
	call	_INIGRP
;src\/Graphics\Graphics.h:384: DISSCR();	// Disable screen (faster to write)
	call	_DISSCR
;src\/Graphics\Graphics.h:388: FILVRM(0x0000, 0x4000, 0x00); //void FILVRM(uint16_t start, uint16_t len, uint8_t data);
	xor	a, a
	push	af
	inc	sp
	ld	hl, #0x4000
	...
	call	_FILVRM
	pop	af
;src\/Graphics\Graphics.h:397: LDIRVM(SPRPAT, sprite_arrow_0, NUMBER_OF_SPRITES * 32);
	inc	sp
	ld	hl,#0x04a0
	ex	(sp),hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:403: for(byte i=0; i<32; i++) {
	ld	c, #0x00
00110$:
;src\/Graphics\Graphics.h:404: WRTVRM(SPRATT + (i * 4), 	192);
	ld	a,c
	cp	a,#0x20
	jr	NC, 00101$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:403: for(byte i=0; i<32; i++) {
	...
	jr	00110$
00101$:
;src\/Graphics\Graphics.h:413: LDIRVM(PATTBL, pattern_black_0, NUMBER_OF_PATTERNS * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0178
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:416: LDIRVM(PATTBL + (256 * 8), pattern_black_0, NUMBER_OF_PATTERNS * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0178
	push	hl
	ld	hl, #_pattern_black_0
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:419: LDIRVM(PATTBL + (512 * 8), pattern_black_0, NUMBER_OF_PATTERNS * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0178
	push	hl
	ld	hl, #_pattern_black_0
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:422: LDIRVM(PATTBL + (NUMBER_OF_PATTERNS * 8), FONT, (HICHAR-LOCHAR+1) * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0300
	push	hl
	ld	hl, #_FONT
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:425: LDIRVM(PATTBL + (256 * 8) + (NUMBER_OF_PATTERNS * 8), FONT, (HICHAR-LOCHAR+1) * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0300
	push	hl
	ld	hl, #_FONT
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:428: LDIRVM(PATTBL + (512 * 8) + (NUMBER_OF_PATTERNS * 8), FONT, (HICHAR-LOCHAR+1) * 8);	//void LDIRVM(uint16_t vdest, const uint8_t* msrc, uint16_t count);
	ld	hl, #0x0300
	push	hl
	ld	hl, #_FONT
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:432: for(byte i=0; i < NUMBER_OF_TITLE_BLOCKS; i++) {
	ld	c, #0x00
00113$:
;src\/Graphics\Graphics.h:433: LDIRVM(PATTBL + (TITLE_1 * 8) + (i * 8), pattern_title, NUMBER_OF_TITLE_BLOCKS * 8);
	ld	a,c
	cp	a,#0x07
	jr	NC, 00102$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:432: for(byte i=0; i < NUMBER_OF_TITLE_BLOCKS; i++) {
	...
	jr	00113$
00102$:
;src\/Graphics\Graphics.h:439: LDIRVM(CLRTBL, color_black_0, NUMBER_OF_PATTERNS * 8);
	ld	hl, #0x0178
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:441: LDIRVM(CLRTBL + (256 * 8), color_black_0, NUMBER_OF_PATTERNS * 8);
	ld	hl, #0x0178
	push	hl
	ld	hl, #_color_black_0
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:443: LDIRVM(CLRTBL + (512 * 8), color_black_0, NUMBER_OF_PATTERNS * 8);
	ld	hl, #0x0178
	push	hl
	ld	hl, #_color_black_0
	push	hl
...
;src\/Graphics\Graphics.h:450: for(byte i = 0; i < (HICHAR - LOCHAR + 1); i++) {
	ld	c, #0x00
00116$:
;src\/Graphics\Graphics.h:451: LDIRVM(CLRTBL + (NUMBER_OF_PATTERNS * 8) + (i * 8), color_font_2, 8);
	ld	a,c
	cp	a,#0x60
	jr	NC, 00103$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:454: for(byte i = 0; i < (HICHAR - LOCHAR + 1); i++) {
	ld	c, #0x00
00119$:
;src\/Graphics\Graphics.h:455: LDIRVM(CLRTBL + (256 * 8) + (NUMBER_OF_PATTERNS * 8) + (i * 8), color_font_2, 8);
	ld	a,c
	cp	a,#0x60
	jr	NC, 00104$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:454: for(byte i = 0; i < (HICHAR - LOCHAR + 1); i++) {
	...
	jr	00119$
00104$:
;src\/Graphics\Graphics.h:458: for(byte i = 0; i < (HICHAR - LOCHAR + 1); i++) {
	ld	c, #0x00
00122$:
;src\/Graphics\Graphics.h:459: LDIRVM(CLRTBL + (512 * 8) + (NUMBER_OF_PATTERNS * 8) + (i * 8), color_font_2, 8);
	ld	a,c
	cp	a,#0x60
	jr	NC, 00105$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:467: for(byte i = 0; i < 10; i++) {
	ld	c, #0x00
00125$:
;src\/Graphics\Graphics.h:468: LDIRVM(CLRTBL + (CHAR_0 * 8) + (i * 8), color_font_1, 8);
	ld	a,c
	cp	a,#0x0a
	jr	NC, 00106$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:471: for(byte i = 0; i < 10; i++) {
	ld	c, #0x00
00128$:
;src\/Graphics\Graphics.h:472: LDIRVM(CLRTBL + (256 * 8) + (CHAR_0 * 8) + (i * 8), color_font_1, 8);
	ld	a,c
	cp	a,#0x0a
	jr	NC, 00107$
	ld	h, #0x00
...
;src\/Graphics\Graphics.h:471: for(byte i = 0; i < 10; i++) {
	...
	jr	00128$
00107$:
;src\/Graphics\Graphics.h:475: for(byte i = 0; i < 10; i++) {
	ld	-1 (ix), #0
00131$:
	ld	a, -1 (ix)
	sub	a, #0x0a
	jr	NC, 00108$
;src\/Graphics\Graphics.h:476: LDIRVM(CLRTBL + (512 * 8) + (CHAR_0 * 8) + (i * 8), color_font_1, 8);
	ld	bc, #_color_font_1
	ld	l, -1 (ix)
	ld	h, #0x00
	add	hl, hl
...
;src\/Graphics\Graphics.h:475: for(byte i = 0; i < 10; i++) {
	...
	jr	00131$
00108$:
;src\/Graphics\Graphics.h:480: LDIRVM(CLRTBL + (TITLE_1 * 8), color_title_1, NUMBER_OF_TITLE_BLOCKS * 8);
	ld	hl, #0x0038
	push	hl
	...
	add	hl, sp
	ld	sp, hl
;src\/Graphics\Graphics.h:488: ENASCR();	// Enable screen
	call	_ENASCR
;src\/Graphics\Graphics.h:489: }
	inc	sp
	pop	ix
	ret
;src\/Graphics\Graphics.h:491: void DrawBlock(byte col, byte line, byte tile) {
;	---------------------------------
; Function DrawBlock
; ---------------------------------
_DrawBlock::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:493: word baseAddr = NAMTBL + (col * 2) + (line * 2 * 32) + PLAYFIELD_HORIZ_OFFSET;
	ld	l, 4 (ix)
	ld	h, #0x00
	add	hl, hl
	ld	c, l
	...
	add	hl, bc
	ex	de, hl
;src\/Graphics\Graphics.h:495: WRTVRM(baseAddr, tile);
	push	de
	ld	a, 6 (ix)
	push	af
	inc	sp
	...
	inc	sp
	pop	de
;src\/Graphics\Graphics.h:496: WRTVRM(baseAddr + 1, tile + 1);
	ld	c, 6 (ix)
	ld	a, c
	inc	a
	ld	l, e
	...
	pop	de
	pop	bc
;src\/Graphics\Graphics.h:497: WRTVRM(baseAddr + 32, tile + 2);
	ld	b, c
	inc	b
	inc	b
	ld	hl, #0x0020
	...
	pop	de
	pop	bc
;src\/Graphics\Graphics.h:498: WRTVRM(baseAddr + 33, tile + 3);
	inc	c
	inc	c
	inc	c
	ld	hl, #0x0021
...
;src\/Graphics\Graphics.h:499: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:501: void DrawBlock_SameTile(byte col, byte line, byte tile) {
;	---------------------------------
...
_DrawBlock_SameTile::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:503: word baseAddr = NAMTBL + (col * 2) + (line * 2 * 32) + PLAYFIELD_HORIZ_OFFSET;
	ld	l, 4 (ix)
	ld	h, #0x00
	add	hl, hl
	ld	c, l
	...
	add	hl, bc
	ex	de, hl
;src\/Graphics\Graphics.h:505: WRTVRM(baseAddr, tile);
	push	de
	ld	a, 6 (ix)
	push	af
	inc	sp
	...
	inc	sp
	pop	de
;src\/Graphics\Graphics.h:506: WRTVRM(baseAddr + 1, tile);
	ld	c, e
	ld	b, d
	inc	bc
	push	de
	...
	inc	sp
	pop	de
;src\/Graphics\Graphics.h:507: WRTVRM(baseAddr + 32, tile);
	ld	hl, #0x0020
	add	hl, de
	push	de
	ld	a, 6 (ix)
	...
	inc	sp
	pop	de
;src\/Graphics\Graphics.h:508: WRTVRM(baseAddr + 33, tile);
	ld	hl, #0x0021
	add	hl, de
	ld	a, 6 (ix)
	push	af
	...
	pop	af
	inc	sp
;src\/Graphics\Graphics.h:509: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:511: void DrawLine(byte line) {
;	---------------------------------
; Function DrawLine
; ---------------------------------
_DrawLine::
	...
	ld	ix,#0
	add	ix,sp
;src\/Graphics\Graphics.h:512: for(byte col = 0; col < COLS_PLAYFIELD; col++) {
	ld	c, 4 (ix)
	ld	b, #0x00
00103$:
	ld	a, b
	sub	a, #0x06
	jr	NC, 00105$
;src\/Graphics\Graphics.h:513: DrawBlock(col, line, playfield[col][line]);
	ld	e, b
	ld	d, #0x00
	ld	l, e
	ld	h, d
...
;src\/Graphics\Graphics.h:512: for(byte col = 0; col < COLS_PLAYFIELD; col++) {
	...
	jr	00103$
00105$:
;src\/Graphics\Graphics.h:515: }
	pop	ix
	ret
;src\/Graphics\Graphics.h:517: void DrawPiece(byte line) {
;	---------------------------------
; Function DrawPiece
; ---------------------------------
_DrawPiece::
;src\/Graphics\Graphics.h:518: DrawLine(line);
	ld	hl, #2
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	call	_DrawLine
	inc	sp
;src\/Graphics\Graphics.h:519: DrawLine(line + 1);
	ld	hl, #2
	add	hl, sp
	ld	b, (hl)
	ld	a, b
	...
	inc	sp
	pop	bc
;src\/Graphics\Graphics.h:520: DrawLine(line + 2);
	inc	b
	inc	b
	push	bc
	inc	sp
	call	_DrawLine
	inc	sp
;src\/Graphics\Graphics.h:521: }
	ret
;src\/Graphics\Graphics.h:523: void DrawPlayfield() {
;	---------------------------------
; Function DrawPlayfield
; ---------------------------------
_DrawPlayfield::
;src\/Graphics\Graphics.h:524: for(byte line = 0; line < LINES_PLAYFIELD; line++) {
	ld	b, #0x00
00103$:
	ld	a, b
	sub	a, #0x0c
	ret	NC
;src\/Graphics\Graphics.h:525: DrawLine(line);
	push	bc
	push	bc
	inc	sp
	call	_DrawLine
...
;src\/Intro.h:86: ChangeFontColor(0x10); // Hide text
	...
	call	_ChangeFontColor
	inc	sp
;src\/Intro.h:88: DrawString("A game by ", 11, 9);
	ld	de, #0x090b
	push	de
	ld	hl, #___str_8
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:89: DrawString("ANDRE BAPTISTA  ", 9, 11);
	ld	de, #0x0b09
	push	de
	ld	hl, #___str_9
	push	hl
...
;src\/Intro.h:90: FadeOut();
	call	_FadeOut
;src\/Intro.h:92: ClearNamesTable();
	call	_ClearNamesTable
;src\/Intro.h:93: DrawString("Powered by", 11, 9);
	ld	de, #0x090b
	push	de
	ld	hl, #___str_10
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:94: DrawString("8 BIT WORKSHOP  ", 9, 11);
	ld	de, #0x0b09
	push	de
	ld	hl, #___str_11
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:95: FadeOut();
	call	_FadeOut
;src\/Intro.h:97: ClearNamesTable();
	call	_ClearNamesTable
;src\/Intro.h:98: DrawString("Powered by", 11, 9);
	ld	de, #0x090b
	push	de
	ld	hl, #___str_10
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:99: DrawString(" MSX TEMPLATES  ", 9, 11);
	ld	de, #0x0b09
	push	de
	ld	hl, #___str_12
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:100: DrawString("by DANILO ANGELO", 8, 13);
	ld	de, #0x0d08
	push	de
	ld	hl, #___str_13
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:101: FadeOut();
	call	_FadeOut
;src\/Intro.h:103: ClearNamesTable();
	call	_ClearNamesTable
;src\/Intro.h:104: DrawString("Beta tester", 11, 9);
	ld	de, #0x090b
	push	de
	ld	hl, #___str_14
	push	hl
	...
	pop	af
	pop	af
;src\/Intro.h:105: DrawString("BIANCA BAPTISTA ", 9, 11);
	ld	de, #0x0b09
	push	de
	ld	hl, #___str_15
	push	hl
